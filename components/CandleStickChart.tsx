...
const CandleStickChart = ({
  ...
  const candleSeriesRf = useRef<ISeriesApi<'Candlestick'> | null>(null);
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      candleSeriesRf.current = null;
    };
  }, [height]);

  useEffect(() => {
    if (!candleSeriesRf.current) return;
    ...
    candleSeriesRf.current.setData(converted);
